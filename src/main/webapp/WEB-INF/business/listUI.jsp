...
<html lang="UTF-8">
    <head>
        ...
        <!-- ALL STYLESHEET -->
        <link href="/svWork/resources/bootstrap/css/bootstrap.min.css" rel="stylesheet">
		<link href="/svWork/resources/css/font-awesome.min.css" rel="stylesheet">
		<link href="/svWork/resources/css/style.css" rel="stylesheet">
		<link href="/svWork/resources/css/blog-single.css" rel="stylesheet">
		<link href="/svWork/resources/css/responsive.css" rel="stylesheet">
    </head>
    ...
    <body>
		...
		<!-- END NAVIGATION -->
		<div class="copyrights">Collect from <a href="http://www.cssmoban.com/" title="ģ��֮��">ģ��֮��</a></div>
		<!-- HOME -->
		<section class="home">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="embed-responsive embed-responsive-16by9">
												<iframe class="embed-responsive-item" src="http://www.youtube.com/embed/-2m6JkJvv4w" autoplay="true"></iframe>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="media-content">
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita debitis porro deserunt est illo eaque ipsum explicabo perspiciatis</p>
								</div>
							</div>
							<div class="media">
								<div class="media-left">
					...
					<div class="col-md-10 col-md-offset-1">
						<div id="supporter-showcase" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner text-center" role="listbox">
								<div class="item active">
									<div class="supporter-name"><img class="img-circle" src="images/card-1.jpg" alt="" />Scott Adams - <span> Founder Of Evonate</span></div>
									<p>Quality-focused Wordpress Theme that our startup went to after previous designers had failed to  deliver. I highly recommend Porton for any business projects.</p>
								</div>
								<div class="item">
									<div class="supporter-name"><img class="img-circle" src="images/card-1.jpg" alt="" />Scott Adams - <span> Founder Of Evonate</span></div>
									<p>Quality-focused Wordpress Theme that our startup went to after previous designers had failed to  deliver. I highly recommend Porton for any business projects.</p>
					...
					<div class="col-md-6 col-sm-7">
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="discover">
								<p>We love to help your business, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita, debitis, porro deserunt est illo eaque, ipsum qui. Explicabo perspiciatis</p>
								<p>We love to help your business, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita, debitis, porro deserunt est illo eaque, ipsum qui. Explicabo perspiciatis, labore voluptatibusLorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita, debitis porro deserunt est illo eaque ipsum qui.<p>
							</div>
							<div role="tabpanel" class="tab-pane" id="development">
								<p>Get awesome ideas from our company, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita, debitis, porro deserunt est illo eaque, ipsum qui. Explicabo perspiciatis.</p>
								<p>Get awesome ideas from our company, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita, debitis, porro deserunt est illo eaque, ipsum qui. Explicabo perspiciatis, labore voluptatibusLorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore rerum ratione quisquam, nisi nulla hic omnis eveniet expedita, debitis, porro deserunt est illo eaque ipsum qui xplicabo.<p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-4">
		...
		<section class="top-footer">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<h1><i class="fa fa-cube"></i> Skyblue</h1>
		...
		<section class="bottom-footer">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						Copyrights 2015 All Reseved More Templates <a href="http://www.cssmoban.com/" target="_blank" title="ģ��֮��">ģ��֮��</a> - Collect from <a href="http://www.cssmoban.com/" title="��ҳģ��" target="_blank">��ҳģ��</a></div>
